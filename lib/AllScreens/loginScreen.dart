...
import 'package:drivers_app_taxi_rouge/AllScreens/registrationScreen.dart';
import 'package:drivers_app_taxi_rouge/AllScreens/mainscreen.dart';
import 'package:drivers_app_taxi_rouge/AllWidgets/progressDialog.dart';
        ...
        if(snap.value !=null)
          {
            ...
            //Navigator.popUntil(context, ModalRoute.withName(MainScreen.idScreen));
