...
import 'package:drivers_app_taxi_rouge/Assistants/requestAssistant.dart';
import 'package:drivers_app_taxi_rouge/DataHandler/appData.dart';
import 'package:drivers_app_taxi_rouge/Models/address.dart';
import 'package:drivers_app_taxi_rouge/Models/allUsers.dart';
import 'package:drivers_app_taxi_rouge/configMaps.dart';
import 'package:drivers_app_taxi_rouge/Models/directDetails.dart';
class AssistantMethods
{
 ...
 static Future<DirectionDetails?> obtainPlaceDirectionDetails(LatLng initialPosition, LatLng finalPosition) async
  ...
  static int calculateFares(DirectionDetails directionDetails)
  {
    ...
    double totalFareAmount = (timeTraveledFared+ distanceTraveledFare)*9.8; // convert to mad
